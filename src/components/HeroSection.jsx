            ...
            <div className="max-w-xl space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="bg-[#006838] hover:bg-white hover:text-[#006838] text-white font-semibold px-12 sm:px-6 py-2 sm:py-3 rounded-full w-fit">
                    <a href='#membership-card-component'>View Plans</a>
                  </button>

                  {/* Tee Time Booking as Link */}
                  <Link to="https://www.paradiseteetimes.com/" className="bg-[#006838] hover:text-[#006838] hover:bg-white text-white font-semibold px-6 sm:px-6 py-2 sm:py-3 rounded-full w-fit text-center inline-flex justify-center items-center">
                    Tee Time Booking
                  </Link>
                </div>

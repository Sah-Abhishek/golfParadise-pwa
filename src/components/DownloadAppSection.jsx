    ...
    <div className="bg-[#1a4d32] flex justify-between items-center w-full h-[700px] px-[60px] py-[40px] relative overflow-hidden">
      ...
      <div className="flex flex-col justify-center w-[500px] relative z-10">
        ...
        <div className="flex gap-[20px]">
          {/* App Store Button */}
          <button className="bg-black rounded-[8px] py-[12px] px-[20px] flex items-center gap-3 hover:bg-gray-900 transition-all duration-200">
            {/* Apple Icon */}
      ...
      <div className="relative flex justify-center items-center min-w-[320px]">

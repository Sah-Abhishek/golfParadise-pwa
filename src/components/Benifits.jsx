  ...
  return (
    <div className="bg-gray-100 px-4 pt-16 pb-2 sm:px-6 lg:px-20">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <h1 className="text-3xl sm:text-4xl font-bold text-center text-black mb-3">
          ...
          <div className="bg-white text-black  p-6 sm:p-8 rounded-xl">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-3">
                <Check className="w-5 h-5 text-yellow-400 mt-1 flex-shrink-0" />
                <span>
                  Join <span className='font-bold'>member-only leagues </span> member-only leagues for all skill levels, with flexible formats and weekly play.

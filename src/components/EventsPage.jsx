  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-[#F7F4EC] font-sans">
        <header className="bg-gray-800 text-white text-center py-20 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1589939705384-5185137a7f0f?q=80&w=2070&auto=format&fit=crop')" }}>

...
const coupons = [
  {
    title: (
      <span>
        <span className="font-bold text-lg text-green-500">Guranteed Free Rounds</span>
        <br />
      </span>
    ),
    description: (
      <div className="space-y-3 text-sm">
        <div className="flex items-start space-x-3">
          <Dot className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
          <span>
  ...
  },
  {
    ...
    title: (
      <span>
        <span className="font-bold text-lg text-green-500">Tournaments-Free Rounds at Selected Premium Courses</span>
      </span>
    ),
    description: (
      <div className="space-y-3 text-sm">
  ...
  },
  {
    title: (
      <span>
        <span className="font-bold text-lg text-green-500">Tee Time Discounts and Double Eagle Coupons</span>
      </span>
    ),
    description: (
      <div className="space-y-3 text-sm">
  ...
  },
  {
    title: (
      <span>
        <span className="font-bold text-lg text-green-500">Member for a day</span>
      </span>
    ),
    description: (
      <div className="space-y-3 text-sm">
  ...
  },
  {
    title: (
      <span>
        <span className="font-bold text-lg text-green-500">Loyalty Credits</span>
      </span>
    ),
    description: (
      <div className="space-y-3 text-sm">
  ...
  return (
    <div className="px-4 py-10 w-full bg-white overflow-x-hidden">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-black text-center mb-10 mt-5">
          Exclusive Deals
        </h2>
